...
@app.route("/student/update-profile", methods=["PUT"])
@jwt_required()
...
@app.route("/student/offer-letter/<int:application_id>")
@jwt_required()
def offer_letter(application_id):
